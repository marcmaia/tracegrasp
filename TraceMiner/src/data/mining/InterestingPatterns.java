...
public class InterestingPatterns {
    ...
    public void selectPatterns(){
        ...
        filterBestPatterns();
        quickSort2(this.sequencePatterns, 0, this.sequencePatterns.size()-1);
    }
     ...
     * @param vetEnd
     */
    private void quickSort2(LinkedList<LinkedList<String>> sequencePatterns, int vetBegin, int vetEnd) {
        int i, j, pivo;
        LinkedList<String> aux = new LinkedList<String>();
        i = vetBegin;
        j = vetEnd;
