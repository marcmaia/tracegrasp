...
//       treemodel = new DefaultTreeModel(root);
    ...
    * @param levelNum
    */
   public boolean begin(Tree buildedTree, String clusterNum, String callNum, 
           String levelNum, String absolutPath, String dir, String maximumClusterNumber,
           int numberOfNodes) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException{
...
//            this. dir = dir;
            this.independentClusterNumber = Integer.parseInt(maximumClusterNumber);
            ...
            applicantsClusters = createJTree(buildedTree, Integer.parseInt(clusterNum), Double.parseDouble(callNum), Integer.parseInt(levelNum));
            classifyClusters();
...
//      }
   ...
   private ArrayList<ToolTipTreeNode> createJTree(Tree buildedTree, int clusterNum, double callNum, int level) {
       tree = buildedTree;
      // root = new DefaultMutableTreeNode("root");
