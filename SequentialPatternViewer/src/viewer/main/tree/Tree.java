...
public class Tree {
    ...
    public JTree start(String strCurrentPath, int option, int size, double support, String subject, JPanel panel, JLabel label) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException, IOException {
         isOk=false;
//            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
//            JFrame frame = new JFrame();
//            Container contentPane = frame.getContentPane();
//            contentPane.setLayout(new GridLayout(1, 1));
            isOk = createTree(strCurrentPath, option, size, support, subject, panel, label);
//            if(isOk){
...
//            }
    ...
    private boolean createTree(String strCurrentPath, int option, int size, double support, String subject, JPanel panel, JLabel label) throws IOException {
...
//                 node.add(newChild);
    ...
    private LinkedList<LinkedList<String>> seekSequentialPatterns(String strCurrentPath, int option, int size, double support, JPanel panel, JLabel label) throws IOException {
